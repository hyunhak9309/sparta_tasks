...
mixin _$ToDoModel {
 ...
 String get id; String get title; String? get description;@JsonKey(name: 'is_favorite') bool get isFavorite;@JsonKey(name: 'is_done') bool get isDone;@JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString, name: 'created_at') DateTime get createdAt;
...
@useResult
$Res call({
 String id, String title, String? description,@JsonKey(name: 'is_favorite') bool isFavorite,@JsonKey(name: 'is_done') bool isDone,@JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString, name: 'created_at') DateTime createdAt
});
...
class _ToDoModel implements ToDoModel {
  const _ToDoModel({required this.id, required this.title, required this.description, @JsonKey(name: 'is_favorite') required this.isFavorite, @JsonKey(name: 'is_done') required this.isDone, @JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString, name: 'created_at') required this.createdAt});
...
@override@JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString, name: 'created_at') final  DateTime createdAt;
