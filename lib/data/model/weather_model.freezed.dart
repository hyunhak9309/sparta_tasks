...
@JsonKey(name: 'temperature_2m') num get temperature;@JsonKey(name: 'wind_speed_10m') num get windSpeed;@JsonKey(name: 'weather_code', fromJson: convertWeatherCode) String get weatherDescription;@JsonKey(name: 'is_day') num get isDay;@JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString) DateTime get time;
...
@useResult
$Res call({
@JsonKey(name: 'temperature_2m') num temperature,@JsonKey(name: 'wind_speed_10m') num windSpeed,@JsonKey(name: 'weather_code', fromJson: convertWeatherCode) String weatherDescription,@JsonKey(name: 'is_day') num isDay,@JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString) DateTime time
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'temperature_2m')  num temperature, @JsonKey(name: 'wind_speed_10m')  num windSpeed, @JsonKey(name: 'weather_code', fromJson: convertWeatherCode)  String weatherDescription, @JsonKey(name: 'is_day')  num isDay, @JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString)  DateTime time)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WeatherModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'temperature_2m')  num temperature, @JsonKey(name: 'wind_speed_10m')  num windSpeed, @JsonKey(name: 'weather_code', fromJson: convertWeatherCode)  String weatherDescription, @JsonKey(name: 'is_day')  num isDay, @JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString)  DateTime time)  $default,) {final _that = this;
switch (_that) {
case _WeatherModel():
return $default(_that.temperature,_that.windSpeed,_that.weatherDescription,_that.isDay,_that.time);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'temperature_2m')  num temperature, @JsonKey(name: 'wind_speed_10m')  num windSpeed, @JsonKey(name: 'weather_code', fromJson: convertWeatherCode)  String weatherDescription, @JsonKey(name: 'is_day')  num isDay, @JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString)  DateTime time)?  $default,) {final _that = this;
switch (_that) {
case _WeatherModel() when $default != null:
return $default(_that.temperature,_that.windSpeed,_that.weatherDescription,_that.isDay,_that.time);case _:
  return null;
...
class _WeatherModel implements WeatherModel {
  const _WeatherModel({@JsonKey(name: 'temperature_2m') required this.temperature, @JsonKey(name: 'wind_speed_10m') required this.windSpeed, @JsonKey(name: 'weather_code', fromJson: convertWeatherCode) required this.weatherDescription, @JsonKey(name: 'is_day') required this.isDay, @JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString) required this.time});
...
@override@JsonKey(name: 'weather_code', fromJson: convertWeatherCode) final  String weatherDescription;
@override@JsonKey(name: 'is_day') final  num isDay;
@override@JsonKey(fromJson: convertToDateTime, toJson: convertToTimeString) final  DateTime time;
